...
namespace java.io
{
	...
	/// </remarks>
	[Sharpen.Sharpened]
	internal class HistoricalCharsetNames
	{
		private static readonly java.util.HashMap<string, string> historicalNames = new java.util.HashMap
			<string, string>();

		static HistoricalCharsetNames()
		{
