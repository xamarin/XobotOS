...
namespace android.database
{
	...
	{
		private sealed class _DataSetObserver_27 : android.database.DataSetObserver
		{
			public _DataSetObserver_27()
			{
			}
		...
		private android.database.DataSetObserver mObserver = new _DataSetObserver_27();
		...
		[Sharpen.Stub]
		[Sharpen.OverridesMethod(@"android.database.AbstractCursor")]
		public override void registerContentObserver(android.database.ContentObserver observer
			)
		{
			throw new System.NotImplementedException();
		}
		...
		[Sharpen.Stub]
		[Sharpen.OverridesMethod(@"android.database.AbstractCursor")]
		public override void unregisterContentObserver(android.database.ContentObserver observer
			)
		{
			throw new System.NotImplementedException();
		}
