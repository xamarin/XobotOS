...
case TRANSACTION_utteranceCompleted:
{
data.enforceInterface(DESCRIPTOR);
java.lang.String _arg0;
_arg0 = data.readString();
this.utteranceCompleted(_arg0);
return true;
}
}
...
public void utteranceCompleted(java.lang.String utteranceId) throws android.os.RemoteException
{
android.os.Parcel _data = android.os.Parcel.obtain();
try {
_data.writeInterfaceToken(DESCRIPTOR);
_data.writeString(utteranceId);
mRemote.transact(Stub.TRANSACTION_utteranceCompleted, _data, null, android.os.IBinder.FLAG_ONEWAY);
}
finally {
_data.recycle();
}
...
static final int TRANSACTION_utteranceCompleted = (android.os.IBinder.FIRST_CALL_TRANSACTION + 0);
}
public void utteranceCompleted(java.lang.String utteranceId) throws android.os.RemoteException;
}
